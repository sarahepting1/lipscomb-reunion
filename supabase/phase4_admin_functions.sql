-- Lipscomb Family Reunion — Phase 4 admin functions
-- Run this once against your Supabase project (SQL Editor -> paste -> Run).
--
-- Each function body is one implicit transaction: if it raises partway
-- through, every write it made is rolled back automatically.
